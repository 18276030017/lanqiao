...
public class CreateXL {
    ...
    public static void main(String argv[]) {
        try {
			...
			HSSFRow row1 = sheet.createRow((short)1);//代表的是第一列第二行
			HSSFRow row2 = sheet.createRow((short)2);//代表的是第一列第三行
			HSSFRow row3 = sheet.createRow((short)3);//代表的是第一列第四行

			HSSFRow row4 = sheet.createRow((short)1);//代表的是第二列第二行
			HSSFRow row5 = sheet.createRow((short)2);//代表的是第二列第三行
			HSSFRow row6 = sheet.createRow((short)3);//代表的是第二列第四行
